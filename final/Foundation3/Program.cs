...
class Program
{
    static void Main(string[] args)
    {
        ...
        Address add1 = new Address("75 North Ceder St", "Sioux Falls", "SD");
        ...
        Address add2 = new Address("1875 Patriot Ave", "Boston", "MA");

        string title3 = "Free Movie at the Park";
        string desc3 = "Join us for a free movie night at James Donlon Park! We will be watching The Incredibles. Bring chairs, blankets, and snacks!";
        DateTime dateAndTime3 = new DateTime(2024,07,06,20,30,00);
        Address add3 = new Address("300 Cherry Blossom Ln", "Ceder Hills", "TN");
